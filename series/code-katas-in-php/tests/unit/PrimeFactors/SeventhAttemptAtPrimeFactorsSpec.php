...
use App\PrimeFactors\SeventhAttemptAtPrimeFactors;
use PhpSpec\ObjectBehavior;

class SeventhAttemptAtPrimeFactorsSpec extends ObjectBehavior
{
    function it_is_initializable()
    {
        $this->shouldHaveType(SeventhAttemptAtPrimeFactors::class);
    }
