...
use App\StringCalculator\ThirdAttemptAtStringCalculator;
use InvalidArgumentException;
use PhpSpec\ObjectBehavior;

class ThirdAttemptAtStringCalculatorSpec extends ObjectBehavior
{
    function it_is_initializable()
    {
        $this->shouldHaveType(ThirdAttemptAtStringCalculator::class);
    }
