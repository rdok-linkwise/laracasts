...
use App\RomanNumerals\EighthAttemptAtRomanNumerals;
use PhpSpec\ObjectBehavior;

class EighthAttemptAtRomanNumeralsSpec extends ObjectBehavior
{
    function it_is_initializable()
    {
        $this->shouldHaveType(EighthAttemptAtRomanNumerals::class);
    }
    ...
    function it_generates_the_roman_equilavent_of_21()
    {
